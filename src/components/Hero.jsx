...
const Hero = () => {
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div
        className={`absolute inset-0 top-[95px]  max-w-7xl mx-auto  ${styles.paddingX} flex flex-row items-start gap-5`}
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Ritvik</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a Frontend Developer <br className='sm:block hidden' />
            who can create 3D websites with animations.
          </p>
        </div>
      </div>
